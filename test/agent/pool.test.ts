...
import type { AgentSessionOptions } from "../../src/agent.js";
...
class FakeRpc extends EventEmitter {
  ...
  constructor(readonly opts: AgentSessionOptions) {
    super();
  }
...
function createPool(overrides: Partial<ConstructorParameters<typeof AgentPool>[0]> = {}) {
