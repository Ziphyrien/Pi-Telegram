...
import type { CronExecuteContext, CronJobRecord, SchedulerOptions, CronStoreData } from "../../src/types.js";
...
function createService(overrides: Partial<SchedulerOptions> = {}): Scheduler {
